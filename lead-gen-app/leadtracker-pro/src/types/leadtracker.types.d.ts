 ...
 */
export type ProspectStatus = 'new' | 'contacted' | 'qualified' | 'meeting_scheduled' | 'proposal_sent' | 'negotiating' | 'closed_won' | 'closed_lost' | 'on_hold';
export type ActivityType = 'call' | 'email' | 'meeting' | 'note';
export type CallOutcome = 'answered' | 'voicemail' | 'no_answer' | 'wrong_number';
export type ReminderType = 'call' | 'email' | 'meeting';
...
//# sourceMappingURL=leadtracker.types.d.ts.map
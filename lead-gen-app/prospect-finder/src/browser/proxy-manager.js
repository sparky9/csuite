...
export class ProxyManager {
    ...
    currentIndex = 0;
    configPath;
    constructor(configPath = './config/proxies.json') {
    ...
    recordFailure(proxy) {
        ...
        if (this.config?.max_failures_before_disable &&
     ...
     */
    getRecommendedProxyCount(concurrentBrowsers) {

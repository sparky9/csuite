...
export class WebsiteScraper extends BaseScraper {
    validateParams(params) {
        return (typeof params.website_url === 'string' &&
     ...
     */
    async extractContactInfo(browser, result) {
        try {
            // Get page content
     ...
     */
    async extractTeamMembers(browser, result) {
        try {
                    ...
                    for (const member of members) {
                        try {
                            ...
                            if (nameText) {
                                ...
                                if (name.match(/^[A-Z][a-z]+(?: [A-Z][a-z]+){1,3}$/) &&
                                    name.length < 50) {
     ...
     */
    async extractServices(browser, result) {
        try {
     ...
     */
    async extractSocialLinks(browser, result, _baseUrl) {
        try {
...
//# sourceMappingURL=website-scraper.js.map
...
// Data Transfer Objects (DTOs) for API/Tool inputs
...
export interface QualityScore {
  ...
  completeness_pct: number; // 0 to 100
  factors: QualityScoreFactors;
  recommendation: 'excellent' | 'good' | 'fair' | 'poor';
}

// Partnership detection types
...
export interface FindPartnershipOpportunitiesParams {
  userId: string;
  yourIndustry: string;
  location?: string;
  maxResults?: number;
...
export interface GeneratePartnershipPitchParams {

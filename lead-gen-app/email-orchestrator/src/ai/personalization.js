 ...
 */
function personalizeSubjectLine(subjectTemplate, prospect) {
    if (!prospect)
 ...
 */
function fallbackPersonalization(context) {
 ...
 */
export async function generateSubjectVariants(baseSubject, count = 3) {
    try {

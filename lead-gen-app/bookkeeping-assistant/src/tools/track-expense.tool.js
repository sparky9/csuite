...
export async function handleTrackExpense(args, userId) {
    ...
    try {
        ...
        if (bookkeepingDb.connected && persistence.databaseId) {
            const expenseInsert = await bookkeepingDb.query(`INSERT INTO bk_expenses (transaction_id, receipt_url, notes)
         VALUES ($1, $2, $3)
         RETURNING id`, [

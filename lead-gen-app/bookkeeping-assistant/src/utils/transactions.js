...
export async function persistTransactionWithAudit(options) {
    ...
    try {
        const inserted = await bookkeepingDb.query(`INSERT INTO bk_transactions (user_id, type, category, description, amount, reference, transaction_date, currency, exchange_rate, metadata)
